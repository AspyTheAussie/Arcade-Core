...
public class Armor
{
  ...
  {
    Inventory inv = new BuyMenu(p, team, BuyMenu.menu.BLOCKS, "Armor").build();
...
/* Location:              C:\Users\homen\Desktop\server\servers\ctf\plugins\ctf.jar!\com\stelch\ctf\Inventories\Armor.class
